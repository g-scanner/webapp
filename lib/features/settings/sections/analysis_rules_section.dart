    ...
    return Material(
      ...
      child: Column(
        children: [
          _buildToggleItem(
            context: context,
            title: "settings.analysisRules.warnAdditivesTitle".tr(),
            subtitle: "settings.analysisRules.warnAdditivesSubtitle".tr(),
            value: warnAdditives,
          ...
          _buildToggleItem(
            context: context,
            title: "settings.analysisRules.strictFilterTitle".tr(),
            subtitle: "settings.analysisRules.strictFilterSubtitle".tr(),
            value: strictMode,
            onChanged: (v) => onToggle(v, 'strictMode'),
          ),
          _buildToggleItem(
            context: context,
            title: "settings.analysisRules.lactoseIntoleranceTitle".tr(),
            subtitle: "settings.analysisRules.lactoseIntoleranceSubtitle".tr(),
            value: alertLactose,
