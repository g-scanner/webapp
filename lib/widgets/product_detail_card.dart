              ...
              children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "${widget.product.brand} • Codice: ${widget.product.barcode}",
                              style: const TextStyle(
                                fontSize: 12,
                                color: Colors.grey,
                              ),
                    ...
                    children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 4),
                                    Text(
                                      "Questo prodotto contiene ingredienti derivati dal latte.",
                                      style: TextStyle(
                                        fontSize: 12,
                                        color: Colors.orange.shade900,
                                      ),
                        ...
                        children: widget.product.allergens.isNotEmpty
                            ...
                            : [
                                Container(
                                  ...
                                  child: Text(
                                    "Nessun allergene critico rilevato",
                                    style: TextStyle(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              "Ingredienti completi: ${widget.product.ingredients}",
                            ...
                            if (widget.product.ingredientsAnalyzed != null &&
                              ...
                              const SizedBox(height: 8),
                              ...widget.product.ingredientsAnalyzed!.map((
                                item,
                              ) {
                                Color itemColor = item.dangerLevel == "danger"
                                    ? Colors.red
                                    : item.dangerLevel == "warning"
                                    ? Colors.orange
                                    : Colors.green;
                                return Container(
                ...
                Container(
                  ...
                  child:
                      ...
                      : ElevatedButton.icon(
                          onPressed: () =>
                              setState(() => _isReporting = !_isReporting),
                          ...
                          label: const Text(
                            "Segnala Etichetta Poco Chiara o Sbagliata",
                          ),
                        ),
                ),
              ],
              ...
              child: _reportSubmitted
                  ...
                  : Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        const Text(
                          "La tua segnalazione avviserà gli altri utenti in tempo reale.",
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          items: const [
                            DropdownMenuItem(
                              value: "label_unclear",
                              child: Text(
                                "Etichetta poco chiara o ambigua",
                                style: TextStyle(fontSize: 12),
                              ),
                            ),
                            DropdownMenuItem(
